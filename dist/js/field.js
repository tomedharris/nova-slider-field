...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-slider-field', __webpack_require__(3));
    Vue.component('detail-nova-slider-field', __webpack_require__(6));
    Vue.component('form-nova-slider-field', __webpack_require__(9));
});
    ...
    [
      _c("template", { slot: "field" }, [
        ...
        _c("input", {
          ...
          staticClass: "w-full form-control form-input shadow-none",
          class: _vm.errorClasses,
          attrs: { id: _vm.field.name, type: "range", min: "-50", max: "50" },
